...
#3. Asssign new age. It duplicates the 'age' vector with a '0' inserted in between.
...
#Outpu: > name = readline(prompt="Input your name: ")
#Input your name: Kent
#> age = readline(prompt="Input your age: ")
#Input your age: 19
#> print(paste("My name is", name, "and I am", age, "years old."))
#[1] "My name is Kent and I am 19 years old."
#> print(R.version.string)
